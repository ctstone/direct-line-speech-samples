...
var StreamingHttpClient_1 = require("./StreamingHttpClient");
var BotFrameworkStreamingAdapter = /** @class */ (function (_super) {
    __extends(BotFrameworkStreamingAdapter, _super);
    function BotFrameworkStreamingAdapter(server, settings) {
        var _this = _super.call(this, settings) || this;
        _this.createConnectorClient = function (serviceUrl) {
    ...
    BotFrameworkStreamingAdapter.prototype.executePipeline = function (context, logic) {
        // tslint:disable-next-line: no-floating-promises
        this.runMiddleware(context, logic);
    };
    // Incoming requests should be handled by the request handler, not the adapter.
    BotFrameworkStreamingAdapter.prototype.processActivity = function (req, res, logic) {
    ...
    return BotFrameworkStreamingAdapter;
}(botbuilder_1.BotFrameworkAdapter));
